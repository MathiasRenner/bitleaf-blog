...
Ich berate deswegen meine Kunden darüber, was sie selbst tun können, um möglichst wenig Daten von sich preis zu geben und damit Meinungsmanipulation nicht weiter unterstützen. Das Ergebnis nennt man <em>Datensouveränität</em>, also die Souveränität oder Kontrolle des Nutzers über seine eigenen Daten. Durch die Nutzung von IT-Systemen, die möglichst keine Daten an deren Hersteller senden, bleibt der Nutzer der Souverän der Daten. Von diesen, meist Open-Source-Systemen, gibt es heute für nahezu alle Anwendungsbereiche ausreichend gute Lösungen.
